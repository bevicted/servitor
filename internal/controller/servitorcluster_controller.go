...
type Reconciler struct {
	...
	// DirectReader bypasses the manager cache for exact publication-resource lookups.
...
// +kubebuilder:rbac:groups=tekton.dev,resources=taskruns,verbs=get;list;watch;delete
